...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        { view: View ->
            ...
            if(flag < 10) {
                flag = flag + 1
                if (temp_edit.text.toString().trim().toInt() == rnds) {
                    binding.apply {
                        Toast.makeText(context, "You guessed "+ flag+" times.", Toast.LENGTH_SHORT).show()
                ...
                flag = 0
                Toast.makeText(context, "Correct answer is "+ rnds, Toast.LENGTH_SHORT).show()
